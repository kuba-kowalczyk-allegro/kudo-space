...
Many other components are available but are not currently installed. A full list can be found at https://ui.shadcn.com/r
...
This project uses the "new-york" style variant with a "neutral" base color and CSS variables for theming, as configured in `components.json`.
